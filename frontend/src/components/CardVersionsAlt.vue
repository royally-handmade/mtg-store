...
<!--TODO: Update to CAD pricing-->

            <!-- Market Price -->
            <td class="px-2 whitespace-nowrap">

                <!-- Normal Price -->
                <div v-if="version.prices?.usd" class="px-2 text-sm">
                  <span class="text-gray-900">
                    ${{ version.prices.usd.toFixed(2) }}
                  </span>
                </div>
                </td>
            <td class="px-2 whitespace-nowrap">
                ...
                <!-- No Price Available -->
                <div v-if="!version.prices && !version.foil_market_price" class="text-sm text-gray-400">
                  No price data
                </div>
