  ...
  <footer class="bg-gray-900 text-white mt-16">
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <!-- Company Info -->
        <div class="space-y-4">
          <h3 class="text-xl font-bold">MTG Marketplace</h3>
          <p class="text-gray-400 text-sm">
            The premier destination for buying and selling Magic: The Gathering cards worldwide.
          </p>
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-2 text-sm">
            <li><router-link to="/cards" class="text-gray-400 hover:text-white">Browse Cards</router-link></li>
            <li><router-link to="/deck-builder" class="text-gray-400 hover:text-white">Deck Builder</router-link></li>
            <li><router-link to="/auth" class="text-gray-400 hover:text-white">Sign In</router-link></li>
            <li><a href="#" @click="showResetPassword = true" class="text-gray-400 hover:text-white cursor-pointer">Reset Password</a></li>
          </ul>
        </div>
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-2 text-sm">
            ...
            <li><a href="#" class="text-gray-400 hover:text-white">Seller Agreement</a></li>
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
        <p class="text-gray-400 text-sm">
          © 2024 MTG Marketplace. All rights reserved.
        </p>
