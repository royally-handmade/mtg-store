      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div v-if="showSuggestions && (suggestedPrice || priceSuggestions.length > 0)"
            ...
            <div v-if="suggestedPrice" class="mb-2">
              <button type="button" @click="applySuggestedPrice"
            ...
            <div v-if="priceSuggestions.length > 0" class="space-y-1">
              ...
              <div class="grid grid-cols-2 gap-2">
                <button v-for="suggestion in priceSuggestions.slice(0, 4)" :key="suggestion.source" type="button"
        ...
        <div class="bg-blue-50 border border-blue-200 rounded p-3">
          <div class="flex justify-between items-center">
            ...
            <button type="button" @click="refreshPriceSuggestions" :disabled="loadingSuggestions"
          ...
          <div v-if="card.market_price_source" class="mt-2">
            <div class="flex items-center text-xs">
              <div class="w-2 h-2 rounded-full mr-2" :class="getMarketPriceQualityColor(card.market_price_source)">
              </div>
        ...
        <div v-if="form.price && competitivenessAlert" class="p-3 rounded-lg"
